<div class="span3" id="">
	...
	<div class="block">
		<div class="navbar navbar-inner block-header">
			<div id="" class="muted pull-left"><h4><i class="icon-pencil"></i> SEND MESSAGE TO AGROVET</h4></div>
		</div>
		<div class="block-content collapse in">
			<div class="span12">
				...
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="message.php">TO AGROVET</a>
					</li>
				</ul>
		...
		<form method="post" id="send_message">
				<div class="control-group">
				  ...
				  <div class="controls">
					...
					<option value="<?php echo $row['user_id']; ?>"> <?php echo $row['category']; ?> </option>
			...
			jQuery("#send_message").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "send_messageToAgrovet.php",
						data: formData,
						success: function(html){
						alert(html);
						$.jGrowl("Message Successfully Sended", { header: 'Message Sent' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'messageAgrovet.php'  }, delay);  

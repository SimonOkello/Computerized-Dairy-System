<div class="span3" id="">
	...
	<div class="block">
		<div class="navbar navbar-inner block-header">
			<div id="" class="muted pull-left"><h4><i class="icon-pencil"></i> SEND MESSAGE TO BANK</h4></div>
		</div>
		...
		<form method="post" id="send_message">
			...
			jQuery("#send_message").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "send_messageToEquity.php",
						data: formData,
						success: function(html){
						alert(html);
						$.jGrowl("Message Successfully Sended", { header: 'Message Sent' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'messageBank.php'  }, delay);  

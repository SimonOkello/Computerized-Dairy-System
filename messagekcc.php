                        ...
                        <div id="block_bg" class="block">
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									...
									<?php
								 $query_announcement = mysql_query("SELECT * FROM kcc_message_sent
																	LEFT JOIN tbluser ON tbluser.user_id = kcc_message_sent.sender_id ORDER BY date_sended DESC
																	")or die(mysql_error());
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			jQuery("#reply_msg").click(function(e){
				...
				<?php include('messageKccForm.php') ?>
            </div>

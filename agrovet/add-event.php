                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#">Updates:</a> <span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								?>
                                <div id="" class="muted"><span class="muted pull-left">POSTED UPDATES </span><span class="muted  pull-right badge badge-info"><?php echo $count; ?></span></div>
                            </div>

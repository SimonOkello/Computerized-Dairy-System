                        ...
                        <div id="block_bg" class="block">
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									...
									<?php
								 $query_announcement = mysql_query("SELECT * FROM bank_message_sent
																	LEFT JOIN tbluser ON tbluser.user_id = bank_message_sent.sender_id
																	where  bank_message_sent.sender_id = '$session_id' order by date_sended DESC
																	")or die(mysql_error());

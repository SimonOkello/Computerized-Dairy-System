                            ...
                            <div class="block-content collapse in">
								...
								?>
									...
									<i class="alert alert-info">
										<span class="icon-edit icon-small" > <a id="edit_event" href="bank_edit-event.php?id=<?php echo $session_id;?>&event=<?php echo $row['id'];?>">EDIT</a></span> | 
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			return false;
				...
				<?php include('bank_Add_diary.php'); ?>
            </div>

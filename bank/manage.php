<?php include('header_dashboard.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('bank_calendar_sidebar.php'); ?>
                            ...
                            <div class="block-content collapse in">
								...
								?>
									...
									<i class="alert alert-info">
										<span class="icon-edit icon-small" > <a id="edit_event" href="bank_edit-event.php?id=<?php echo $session_id;?>&event=<?php echo $row['event_id'];?>">EDIT</a></span> | 
